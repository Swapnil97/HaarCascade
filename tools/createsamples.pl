...
my $cmd = 'opencv_createsamples -bg negatives.txt -info info/infor.lst -pngoutput info -maxxangle 0.5 -maxyangle 0.5 -maxzangle 0.5 -num 1000 -bgcolor 0 -bgthresh 8 -w 48 -h 48';
my $totalnum = 7000;
my $tmpfile  = 'tmp';
